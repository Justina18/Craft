...
const cardData: CardData[] = [
  ...
  },
  {
    id: "2",
    title: "Develop",
    description: "Build robust applications with cutting-edge technologies and best practices",
    color: "#0f172a",
  },
  {
    id: "3",
    title: "Deploy",
    description: "Ship your products to production with confidence and reliability",
    color: "#334155",
  },
  {
    id: "4",
    ...
    <main className="relative min-h-screen w-full bg-black/0">
      ...
      >
        <h4 className="mt-8 font-mono text-sm font-medium sm:text-base md:mt-0">
          Made by{" "}
          <a
            href="https://nina-portfolio-beta.vercel.app/"
            target="_blank"
